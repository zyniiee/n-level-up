  ...
  return (
    <div className="pb-32">
      <div className="section_container relative flex items-center">
        <div className="flex gap-16 w-full">
          ...
          >
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="xl:w-1/2 w-3/4">{about[currentIndex].subText}</p>
            </div>
          </motion.div>
        </div>
        ...
        <button
          onClick={handlePrev}
          className="absolute md:left-[10vw]  left-[2rem] rounded-full p-2"
        >
          <img src="./icons/footer-arrow-left.svg" alt="arrow left" />
        </button>
        <button
          onClick={handleNext}
          className="absolute md:right-[10vw] right-[2rem] rounded-full p-2"
        >
